package dev.lvstrng.vxe.managers;
	...
	public void loadProfile() {
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Vxe.INSTANCE.getModuleManager().getModules()) {
					JsonElement moduleJson = profile.get(String.valueOf(Vxe.INSTANCE.getModuleManager().getModules().indexOf(module)));
		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Vxe.INSTANCE.getModuleManager().getModules()) {
					...
					profile.add(String.valueOf(Vxe.INSTANCE.getModuleManager().getModules().indexOf(module)), moduleConfig);
				}
