package dev.lvstrng.vxe.gui.components.settings;

import dev.lvstrng.vxe.Vxe;
import dev.lvstrng.vxe.gui.components.ModuleButton;
import dev.lvstrng.vxe.module.modules.client.ClickGUI;
import dev.lvstrng.vxe.module.setting.Setting;
import dev.lvstrng.vxe.module.setting.StringSetting;
            ...
            mc.setScreen(new Screen(Text.empty()) {
                ...
                public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
                    if(keyCode == GLFW.GLFW_KEY_ESCAPE) {
                        ...
                        mc.setScreen(Vxe.INSTANCE.clickGui);
                    }
